...
##                cv2.imshow("ROI", roi)
                ...
                text="count : "+ str(circles.shape[1])
                font = cv2.FONT_HERSHEY_COMPLEX
                cv2.putText(roi2,text,(50,150), font, 3,(0,255,255),4,cv2.LINE_AA)
...
class New_Toplevel:
    def __init__(self, top=None):
        ...
        # self._img1 = PhotoImage(file="warehouse.jpg")
        ...
        self.Button1.place(relx=0.12, rely=0.51, height=43, width=150)
        ...
        self.Button1.configure(text='''Vacant Square Shelves''')
        self.Button1.configure(width=126)

        self.Button2 = Button(self.Frame1,command=getImageRectangle)
        self.Button2.place(relx=0.32, rely=0.51, height=43, width=150)
        ...
        self.Button2.configure(text='''Vacant Rectangular Shelves''')
        self.Button2.configure(width=126)

        self.Button3 = Button(self.Frame1,command=circles)
        self.Button3.place(relx=0.55, rely=0.51, height=43, width=150)
        ...
        self.Button3.configure(text='''Available Square Shelves''')
        self.Button3.configure(width=116)

        self.Button4 = Button(self.Frame1,command=circles)
        self.Button4.place(relx=0.77, rely=0.51, height=43, width=150)
        ...
        self.Button4.configure(text='''Available Rect Shelves''')
        self.Button4.configure(width=116)

        self.Label2 = Label(self.Frame1)
        self.Label2.place(relx=0.31, rely=0.08, height=76, width=400)
        self.Label2.configure(background="#d9d9d9")
        self.Label2.configure(disabledforeground="#a3a3a3")
        self.Label2.configure(font=font12)
        self.Label2.configure(foreground="#000000")
        self.Label2.configure(text='''Stocks Monitoring App''')
